...
`/reload-plugins` 직후부터 6개 슬래시 커맨드 (`/crucible:brainstorm` · `/crucible:plan` · `/crucible:verify` · `/crucible:compound` · `/crucible:orchestrate` · `/crucible:dogfood`)와 PreToolUse 가드 훅이 현재 세션에서 바로 활성화됩니다. 확인:
