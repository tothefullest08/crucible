...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/2026-04-19/03-design/final-spec.md` — **v3.1 §4.2.3 72h smoke 체크리스트** (C-1~C-5)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/2026-04-19/04-planning/implementation-plan.md` §W1 — T-W1-08 정의
...
# 3. stage
git add .github/workflows/ __tests__/fixtures/jsonl-smoke/ .claude/plans/2026-04-19/04-planning/implementation-plan.md
