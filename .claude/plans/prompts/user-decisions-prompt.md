...
1. `/Users/ethan/Desktop/personal/harness/.claude/plans/INDEX.md` — 전체 프로젝트 맥락
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — v2 최종 스펙 (특히 §11 설계 미결)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/section11-promotion-tracker.md` — **§11-1~7 승격 체크리스트, 유저 판단 5건 상세 포함**
4. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec-review.md` — P0/P1 finding 원천 (P1-1 포지셔닝 등)
...
**`/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/user-decisions-5.md`** 생성:
