...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — **v3.3** (§3.4 승격 게이트 UX 정식, §2.1 #6 오염 방지)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W5 — T-W5-04·05·06·07·08
4. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/s11-3-ux-draft.md` — 승격 게이트 상세
...
7. `/Users/ethan/Desktop/personal/harness/.claude/plans/prompts/_git-workflow-template.md`
8. **레퍼런스** (read-only):
...
git add scripts/ hooks/stop.sh skills/compound/templates/ __tests__/fixtures/ .claude/memory/corrections/_rejected/ .claude/state/detector-status.json .claude/plans/04-planning/implementation-plan.md
