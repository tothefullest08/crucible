...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — v3.1 (§10 AC 기준)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W3 — T-W3-08 정의
...
# Step 3: stage
git add __tests__/integration/test-ac3-plan-format.sh __tests__/fixtures/plan-ac3/ .claude/plans/04-planning/implementation-plan.md
