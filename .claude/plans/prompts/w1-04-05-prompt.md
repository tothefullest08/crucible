...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — v3.1 최신 (§4.3 보안 제약 필수 준수)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W1 — T-W1-04·05 정의
...
# 3. 본인 파일만 stage
git add hooks/session-start skills/using-harness/ .claude/plans/04-planning/implementation-plan.md
