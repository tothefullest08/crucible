...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — **v3.2** (§2.1 #5 Evaluator, §4.3.5·6·7 보안, §4.2 JSONL)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W4
...
git add agents/verify/ agents/evaluator/ skills/verify/SKILL.md hooks/drift-monitor.sh __tests__/integration/test-ac4-qa-judge-threshold.sh .claude/plans/04-planning/implementation-plan.md
