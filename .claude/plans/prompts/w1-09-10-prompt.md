...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — v3.1 **§4.3 보안 제약** (쌍따옴표·eval 금지·slug 화이트리스트)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W1 — T-W1-09·10 정의
...
# 3. stage
git add __tests__/security/ __tests__/integration/ .claude/plans/04-planning/implementation-plan.md
