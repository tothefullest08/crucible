...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — **v2 현재 상태 (수정 대상)**
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/user-decisions-5.md` — **유저 판단 5건 확정 (반영 소스)**
4. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec-review.md` — 원 리뷰 findings
5. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/section11-promotion-tracker.md` — §11-1~7 체크리스트
6. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/porting-matrix.md` — 라이선스 매트릭스 업데이트 대상
...
1. **`.claude/plans/03-design/final-spec.md`** — v3 덮어쓰기 (v2 구조 유지 + 위 5건 승격)
2. **`.claude/plans/04-planning/porting-matrix.md`** — 라이선스 컬럼 업데이트 + 비호환 플래그
3. **`.claude/plans/04-planning/section11-promotion-tracker.md`** — §11 각 항목 상태 업데이트
4. **`.claude/plans/03-design/v3-change-log.md`** (신규) — v2 → v3 변경 요약 (각 승격별 before/after)
