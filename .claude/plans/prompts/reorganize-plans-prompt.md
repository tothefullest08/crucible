...
- `.claude/plans/01-requirements/clarified-spec.md` → `.claude/plans/01-requirements/clarified-spec.md`
- `.claude/plans/02-research/synthesis.md` → `.claude/plans/02-research/synthesis.md`
- `.claude/plans/03-design/final-spec.md` → `.claude/plans/03-design/final-spec.md`
