...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — v3.3 (§3.4 승격 게이트, §2.1 #6 오염 방지)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W6 — T-W6-02·03
...
git add skills/compound/SKILL.md scripts/session-wrap-pipeline.sh agents/compound/ .claude/plans/04-planning/implementation-plan.md
