...
git mv .claude/plans/00-recommendations   .claude/plans/2026-04-19/00-recommendations
git mv .claude/plans/01-requirements      .claude/plans/2026-04-19/01-requirements
git mv .claude/plans/02-research          .claude/plans/2026-04-19/02-research
git mv .claude/plans/03-design            .claude/plans/2026-04-19/03-design
git mv .claude/plans/04-planning          .claude/plans/2026-04-19/04-planning
git mv .claude/plans/prompts              .claude/plans/2026-04-19/prompts
git mv .claude/plans/INDEX.md             .claude/plans/2026-04-19/INDEX.md
...
# 치환 패턴 (고정 순서로 7종)
PATTERNS=(
  ".claude/plans/00-recommendations:.claude/plans/2026-04-19/00-recommendations"
  ".claude/plans/01-requirements:.claude/plans/2026-04-19/01-requirements"
  ".claude/plans/02-research:.claude/plans/2026-04-19/02-research"
  ".claude/plans/03-design:.claude/plans/2026-04-19/03-design"
  ".claude/plans/04-planning:.claude/plans/2026-04-19/04-planning"
  ".claude/plans/prompts:.claude/plans/2026-04-19/prompts"
  ".claude/plans/INDEX.md:.claude/plans/2026-04-19/INDEX.md"
)
...
> 만약 `.claude/plans/prompts/2026-04-20-plans-reorg-prompt.md`(본 프롬프트)도 있다면 **그것도 2026-04-19/prompts/ 안으로 이동 완료된 상태**. 본 프롬프트는 초기 구현 에픽 결과물이 아니지만, 프롬프트 관리 일관성을 위해 기존 prompts/ 폴더에 있었으면 이동 대상에 포함.
>
