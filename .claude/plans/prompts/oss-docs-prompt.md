...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — v3.1 (§1 포지셔닝 · §4.5 라이선스 정책)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/user-decisions-5.md` — 포지셔닝 최종안 (§5)
