...
2. `/Users/ethan/Desktop/personal/harness/.claude/plans/03-design/final-spec.md` — **v3.3** (§4.3.7 correction-detector 부정 문맥, §3.4 승격 게이트, §2.1 #6 오염 방지)
3. `/Users/ethan/Desktop/personal/harness/.claude/plans/04-planning/implementation-plan.md` §W5 — T-W5-09·10
...
6. `/Users/ethan/Desktop/personal/harness/.claude/plans/prompts/_git-workflow-template.md`
...
git add hooks/correction-detector.sh scripts/global-memory-tag.sh scripts/lib/project-id.sh .claude-plugin/plugin.json __tests__/security/fixtures/correction-detector/ __tests__/security/fixtures/global-memory/ .claude/plans/04-planning/implementation-plan.md
